...
if (isLandingPage) {
nav.innerHTML = '<h3>Menu</h3><ul><li><a href="dashboard.html">\U0001F4CA Dashboard</a></li></ul><h3>Subjects</h3><ul>' +
...
nav.innerHTML = '<h3>Menu</h3><ul><li><a href="' + prefix + 'dashboard.html">\U0001F4CA Dashboard</a></li></ul><h3>Topics</h3><ul id="sidebar-topics"><li><a href="' + landingHref + '">&larr; ' + (subjectSlug.replace(/-/g,' ')) + '</a></li></ul>';
